...
proc insert (value : ^queue, current : ^queue)
    if value -> value < front -> value then
	value -> Next := front
	front := value
    ...
    elsif value -> value < current -> Next -> value then
...
loop
	...
	label "4" :
	    ...
	    put finditem (a)
	label "5" :
	       put  "Enter position of item you wish to delete"
	    var a : int
	    get a
	    deleteitem (a)
