...
function binSearch (spSearchArray : array 1 .. * of string (10), spSearchName : string (10), num : int) : int
    ...
    loop
	exit when high < low or low > high
	mid := (high + low) div 2
...
if NumOfNames >= 1 then
	...
	pos := binSearch (SearchArray, Name, NumOfNames)
